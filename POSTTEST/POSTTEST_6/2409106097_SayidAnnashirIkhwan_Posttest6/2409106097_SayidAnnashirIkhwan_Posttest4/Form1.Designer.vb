...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Label3 = New Label()
        Label4 = New Label()
        menuPokemon = New ToolStripMenuItem()
        MenuStrip1.SuspendLayout()
        SuspendLayout()
        ' 
        ' MenuStrip1
        ' 
        MenuStrip1.Items.AddRange(New ToolStripItem() {menuInput, menuLihat, menuSimpan, menuBuka, menuKeluar, menuPokemon})
        ...
        ' menuPokemon
        ' 
        menuPokemon.Name = "menuPokemon"
        menuPokemon.Size = New Size(125, 20)
        menuPokemon.Text = "Lihat data pokemon"
        ' 
        ' Form1
        ' 
    ...
    Friend WithEvents menuPokemon As ToolStripMenuItem
